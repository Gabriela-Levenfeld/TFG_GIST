...
if __name__ == '__main__':
    ...
    total_epochs = 40
    self_loop = True
    graph_feat_size = 128 #Este parámetro no se usa
    num_layers = 2 #Este parámetro no se usa
    dropout = 0.2 #Este parámetro no se usa
    learning_rate = 1e-3
    SEED = 129767345
    #########################
    rt_scaler = 'robust'
    ...
    reg = MPNNPredictor(node_in_feats=graph.ndata['h'].shape[1],
    ...
    losses.to_csv('losses_MPNNPredictor.csv', index=False)
    print('Done')
